...
import ita.homi.component.admin.CalendarioComponent;
...
public class CalendarioView extends VerticalLayout implements View {
    ...
    public CalendarioView() {
        ...
        addComponent(rowTop);
        setExpandRatio(rowTop, 0.5f);
        
        

        //Pannello Sinistra
        rowTop.addComponent(createPanel(new CalendarioComponent(23,3)));
