    ...
    private Component buildDraftsView() {
        ...
        editors.setCloseHandler(new CloseHandler() {
            ...
            public void onTabClose(TabSheet tabsheet, final Component tabContent) {
                ...
                Label message = new Label("Report NON Salvato!!!!");
                ...
                ok.addClickListener(new ClickListener() {
                    ...
                    public void buttonClick(ClickEvent event) {
                        ...
                        Notification
                                .show("Il Report è tra i Draft!!!",
                                        "Actually, chiuso 4ever.",
        ...
        center.setSizeFull();
        center.setCaption("TUTTI I DRAFT!!!!!!!!!!!!!");
        ...
        Label draftsTitle = new Label("DRAFTSTSTSTST");
        ...
        Label draftTitle = new Label(
                "REVENUE DEL MESE CRISTO<br><span>ULTIMA MODIFICA.............</span>",
                ContentMode.HTML);
    ...
    private AbstractComponent createComponentFromPaletteItem(String caption,
        ...
        if (caption != null) {
            if (caption.equals("text")) {
               ...
               // t.setContainerDataSource(((IsoUI) getUI()).dataProvider
                 //       .getRevenueByTitle());
                t.setWidth("100%");
                t.setPageLength(0);
